<?php 
    ...
    { 
        ...
        {
            $Display = "SELECT tblsales.*, tblsalesinvoice.time FROM tblsales INNER JOIN tblsalesinvoice WHERE tblsales.invoiceNO=tblsalesinvoice.invoiceNO AND tblsalesinvoice.time >= '".$today."'";
            //Search
        ...
        {
            $Display = "SELECT * FROM tblsalesinvoice WHERE time >= '".$today."'";
            //Filter
            if (isset($_GET["Search"])) {
                $Display .= empty($_GET["Search"]) ? "" : "AND (invoiceNO LIKE '%".$_GET["Search"]."%' OR total LIKE '%".$_GET["Search"]."%' OR bill LIKE '%".$_GET["Search"]."%')";;
                !empty($_GET["Search"]) ? $_SESSION["Search"]=$_GET["Search"] : $_SESSION["Search"]="";}
            $Display .= " ORDER BY tblsalesinvoice.time DESC";
        }
